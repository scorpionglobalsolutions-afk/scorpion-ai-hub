...
<div class="footer">
  <p style="margin-bottom:10px;"><span class="badge badge-good">✓ Data Verified</span> <span style="margin-left:8px;font-size:0.8rem;">Report generated using real-time website scraping, Google Business Profile data, and directory verification</span></p>
  ...
  const generateAudit = trpc.seoAudit.generateAudit.useMutation({
    onSuccess: (data: any) => {
      if (data.success) {
        ...
        toast.success("Snapshot report generated with real data!");
      } else {
          ...
          <Card className="border-0 shadow-md">
            <CardContent className="p-12 text-center">
              ...
              <div className="max-w-md mx-auto space-y-2 text-left text-sm text-slate-500">
                ...
                <div className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-emerald-500 animate-pulse" /> Detecting social media presence</div>
                <div className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-emerald-500 animate-pulse" /> Finding local competitors</div>
                <div className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-emerald-500 animate-pulse" /> Generating AI-powered analysis</div>
              </div>
            </CardContent>
          </Card>
        )}
