    ...
    <div className="min-h-screen bg-background dark:from-slate-950 dark:to-slate-900 p-6">
      <div className="max-w-6xl mx-auto">
        <div className="mb-8 flex items-center gap-3">
          ...
          <div>
            <h1 className="text-3xl font-bold text-foreground dark:text-white">Reputation Management</h1>
            <p className="text-muted-foreground dark:text-muted-foreground">Generate professional review responses instantly</p>
          </div>
        </div>
